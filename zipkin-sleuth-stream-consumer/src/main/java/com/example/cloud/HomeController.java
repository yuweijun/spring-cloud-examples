...
class HomeController {
    ...
    public String service1() {
        ...
        String result = this.restTemplate.getForObject("http://localhost:9852/service2", String.class);
    ...
    public String service2() {
        ...
        int sleep = randomSleepMillis();
        String result = this.restTemplate.getForObject("http://localhost:9853/service3", String.class);
    ...
    public String service3() {
        ...
        int sleep = randomSleepMillis();
        String result = this.restTemplate.getForObject("http://localhost:9854/service4", String.class);
